...
Mouse PRKO bulk RNA-seq were performed using paiered end sequencing method and below are the scripts for trimming and mapping paired end sequencing read.
